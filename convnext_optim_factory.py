...
def create_optimizer(
    ...
    opt_split = optimizer_name.split("_")
    optimizer_name = opt_split[-1]
    if optimizer_name == "sgd" or optimizer_name == "nesterov":
    ...
    elif optimizer_name == "rmsproptf":
        optimizer = RMSpropTF(parameters, alpha=0.9, momentum=momentum, **opt_args)
    # elif opt_lower == 'novograd':
    #     optimizer = NovoGrad(parameters, **opt_args)
    elif optimizer_name == "nvnovograd":
        optimizer = NvNovoGrad(parameters, **opt_args)
    elif optimizer_name == "fusedsgd":
        opt_args.pop("eps", None)
        optimizer = FusedSGD(parameters, momentum=momentum, nesterov=True, **opt_args)
    elif optimizer_name == "fusedmomentum":
        opt_args.pop("eps", None)
        optimizer = FusedSGD(parameters, momentum=momentum, nesterov=False, **opt_args)
    elif optimizer_name == "fusedadam":
        optimizer = FusedAdam(parameters, adam_w_mode=False, **opt_args)
    elif optimizer_name == "fusedadamw":
        optimizer = FusedAdam(parameters, adam_w_mode=True, **opt_args)
    elif optimizer_name == "fusedlamb":
        optimizer = FusedLAMB(parameters, **opt_args)
    elif optimizer_name == "fusednovograd":
